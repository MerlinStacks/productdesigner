...
== Changelog ==
= 1.0.3 - 2025-05-19 =
* Fix: Removed scrollbars from designer interface for a cleaner look
* Fix: Fixed font selection issues in the designer
* Enhancement: Improved designer positioning to center properly on the page
* Enhancement: Enhanced CSS for better overall user experience and accessibility
